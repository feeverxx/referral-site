...
function toggleCard(card) {
    // Simply toggle the clicked card without affecting others
    card.classList.toggle('expanded');
}

// Toggle FAQ items
function toggleFAQ(faqItem) {
    // Simply toggle the clicked FAQ item without affecting others
    faqItem.classList.toggle('expanded');
}

// Add any additional JavaScript functionality here

// Admin giriş kodu kaldırıldı - artık şifre sistemi kullanılıyor
